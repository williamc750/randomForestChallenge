...
text(15, max(dt_test_rmse) * 0.95, "Overfitting\nGap Widens", 
     col = "darkred", font = 2, cex = 0.8)

# Plot 2: Random Forests - No Overfitting
plot(rf_trees, rf_test_rmse, 
     type = "b", pch = 19, col = "red", lwd = 2,
     xlab = "Number of Trees (log scale)", ylab = "RMSE",
     main = "Random Forests: No Overfitting",
     log = "x", xaxt = "n", ylim = range(c(rf_train_rmse, rf_test_rmse)))
...
text(500, max(rf_test_rmse) * 0.95, "No Overfitting\nGap Stays Small", 
